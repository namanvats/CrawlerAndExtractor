package com.amazonCrawlerExtractor.project.service;

import com.amazonCrawlerExtractor.project.Constants;
import com.amazonCrawlerExtractor.project.helper.RandomUserAgent;
import com.amazonCrawlerExtractor.project.repository.ProductRepositoryImpl;
    ...
    public URLtoSKUMapping getDocument(String url, String skuId) throws IOException {
        ...
        try {
            ...
            document = Jsoup.connect(fetchURL.url).header("Accept-Encoding", "gzip, deflate")
                    ...
                    .cookies(cookies)
                    .get();
                    // Uncomment Below line to see the value of Document
